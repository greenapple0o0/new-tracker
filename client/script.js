class CompetitiveTrack {
    ...
    showWaterIncrement(player) {
        ...
        document.getElementById('waterCurrentTotal').textContent = `Current Total: ${currentWater}mL`;
    ...
    updateWaterPointsPreview() {
        ...
        const points = Math.floor(amount / 750); // 750mL = 1 point
    ...
    showWorkoutIncrement(player) {
        ...
        document.getElementById('workoutCurrentTotal').textContent = `Current Total: ${currentWorkout}`;
    ...
    updateWorkoutPointsPreview() {
        ...
        const points = Math.floor(minutes / 30); // 30 minutes = 1 point
    ...
    getCurrentWorkout(player) {
        ...
        if (!workoutTask) return '0 minutes';
        const value = player === 1 ? workoutTask.player1Value : workoutTask.player2Value;
        const totalMinutes = Math.round(value * 60); // Convert hours to minutes
    ...
    renderModalBasedTask(task, index, canEditNish, canEditJess, isWaterTask, isWorkoutTask) {
        ...
        if (isWaterTask) {
            ...
            valueSuffix = ' minutes';
            nishDisplayValue = Math.round(nishValue * 60); // Convert hours to minutes
            jessDisplayValue = Math.round(jessValue * 60); // Convert hours to minutes
            ...
            <div class="task-controls">
                <div class="task-player">
                    ...
                    <div class="points-info" style="text-align: center; font-size: 0.8em; color: #666;">
                        ${Math.floor(isWaterTask ? nishValue / 750 : (nishValue * 60) / 30)} points
                    </div>
                </div>
                <div class="task-player">
                    <div class="task-player-label">Jess</div>
                    ...
                    <div class="points-info" style="text-align: center; font-size: 0.8em; color: #666;">
                        ${Math.floor(isWaterTask ? jessValue / 750 : (jessValue * 60) / 30)} points
                    </div>
                </div>
            </div>
            ...
            <div class="task-controls">
                <div class="task-player">
                    ...
                    <div class="number-controls">
                        ...
                        <div class="number-value">${nishValue} hours</div>
                ...
                <div class="task-player">
                    ...
                    <div class="number-controls">
                        ...
                        <div class="number-value">${jessValue} hours</div>
